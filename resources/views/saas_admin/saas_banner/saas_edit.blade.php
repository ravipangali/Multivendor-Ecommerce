            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('admin.banners.show', $banner->id) }}" class="btn btn-info">
                        <i class="align-middle" data-feather="eye"></i> View Banner
                    </a>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="link_url" name="link_url" value="{{ old('link_url', $banner->link_url) }}" placeholder="https://example.com">
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_active" id="is_active_1" value="1" {{ old('is_active', $banner->is_active) == '1' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="is_active_1">Active</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_active" id="is_active_0" value="0" {{ old('is_active', $banner->is_active) == '0' ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Leave empty to keep the current image. Recommended size depends on position:
                        ...
                        <div class="mt-3">
                            ...
                            <div class="border p-3 text-center">
                                @if($banner->image)
                                    <img src="{{ asset('storage/'.$banner->image) }}" alt="{{ $banner->title }}" class="img-fluid" style="max-height: 200px;">
                                @else
