    ...
    <div class="container">
        <div class="breadcrumb-inner">
            ...
            <div class="breadcrumb-content">
                <h2 class="breadcrumb-title">Edit Payment Method</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Method</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="payment-methods-header">
                     <h2 class="mb-0 text-white">Edit Payment Method</h2>
                </div>

                <div class="form-card">
                    <form action="{{ route('customer.payment-methods.update', $paymentMethod->id) }}" method="POST" id="paymentMethodForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div id="bank_fields" class="{{ $paymentMethod->type !== 'bank_transfer' ? 'd-none' : '' }}">
                             <h5 class="mb-3">Bank Account Details</h5>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="bank_name" class="form-label">Bank Name <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="details[bank_name]" value="{{ old('details.bank_name', $paymentMethod->details['bank_name'] ?? '') }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="branch_name" class="form-label">Branch Name <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="details[branch_name]" value="{{ old('details.branch_name', $paymentMethod->details['branch_name'] ?? '') }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="account_name" class="form-label">Account Holder Name <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="details[account_name]" value="{{ old('details.account_name', $paymentMethod->details['account_name'] ?? '') }}">
                                </div>
                                 <div class="col-md-6 mb-3">
                                    <label for="account_number" class="form-label">Account Number <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="details[account_number]" value="{{ old('details.account_number', $paymentMethod->details['account_number'] ?? '') }}">
                                </div>
                            </div>
                        </div>

                        <!-- eSewa Fields -->
                        <div id="esewa_fields" class="{{ $paymentMethod->type !== 'esewa' ? 'd-none' : '' }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="details[esewa_id]" value="{{ old('details.esewa_id', $paymentMethod->details['esewa_id'] ?? '') }}">
                            </div>
                        </div>

                        <!-- Khalti Fields -->
                        <div id="khalti_fields" class="{{ $paymentMethod->type !== 'khalti' ? 'd-none' : '' }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="details[khalti_id]" value="{{ old('details.khalti_id', $paymentMethod->details['khalti_id'] ?? '') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-check form-switch mb-4">
                            <input class="form-check-input" type="checkbox" id="is_default" name="is_default" value="1" {{ old('is_default', $paymentMethod->is_default) ? 'checked' : '' }} style="width: 2.5em; height: 1.25em;">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary-custom">Update Method</button>
                        </div>
                    </form>
                </div>
            </div>
