    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('seller.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3" id="regular-pricing" x-data="{ hasVariations: {{ $product->has_variations ? 'true' : 'false' }} }" x-init="$watch('hasVariations', value => { document.getElementById('regular-pricing').style.display = value ? 'none' : 'flex'; })" x-show="!hasVariations">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-4 mb-3">
                                                <img src="{{ $image->image_url }}"
                                                    alt="Product Image" class="img-thumbnail" style="max-height: 150px;">
                                            </div>
                                            @endforeach
                                        </div>
                                        <p class="text-muted">Note: Uploading new additional images will replace all current additional images.</p>
                                    </div>
                                    @endif
                                </div>
                            </div>
