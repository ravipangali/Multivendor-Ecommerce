...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h4">My Transactions</h1>
                <div>
                    <a href="{{ route('seller.transactions.export', request()->query()) }}" class="btn btn-success">
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    <h6 class="text-white card-title">Current Balance</h6>
                    <h4 class="text-white ">${{ number_format($balance, 2) }}</h4>
                </div>
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="card bg-success text-white">
                <div class="card-body">
                    <h6 class="text-white card-title">Total Earnings</h6>
                    <h4 class="text-white ">${{ number_format($totalDeposits + $totalCommissions, 2) }}</h4>
                </div>
            </div>
        </div>
        <div class="col-md-3">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('seller.transactions.index') }}">
                <div class="row">
                    <div class="col-md-3">
        ...
        <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($transaction->order)
                                            <a href="{{ route('seller.orders.show', $transaction->order->id) }}" class="text-primary">
                                    ...
                                    <td>
                                        <a href="{{ route('seller.transactions.show', $transaction->id) }}" class="btn btn-sm btn-primary">
            ...
            @else
                <div class="text-center py-4">
                    ...
                    <p class="text-muted">You do not have any transactions yet.</p>
                </div>
            @endif
        </div>
    </div>
