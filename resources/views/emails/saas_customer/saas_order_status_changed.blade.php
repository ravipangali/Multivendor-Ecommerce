...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <p>Hello {{ $recipient === 'customer' ? $order->customer->name : $order->seller->name }},</p>
                        ...
                        <div class="item-info">
                            ...
                            <div class="item-details">
                                ...
                                @if($item->productVariation)
                                    | Variation: {{ $item->productVariation->attribute->name }}: {{ $item->productVariation->attributeValue->value }}
                                @endif
                            </div>
                        </div>
            ...
            <div style="text-align: center;">
                @if($recipient === 'customer')
                    <a href="{{ route('customer.order.detail', $order->id) }}" class="button">View Order Details</a>
                @else
                    <a href="{{ route('seller.orders.show', $order->id) }}" class="button">View Order Details</a>
                @endif
            </div>
